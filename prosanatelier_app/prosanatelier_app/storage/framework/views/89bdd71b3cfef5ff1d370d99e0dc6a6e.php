...
<head>
    ...
    <title>Invoice <?php echo e($order->order_number); ?> - <?php echo e($siteSettings['site_name'] ?? 'Prosan Atelier'); ?></title>
    <style>
...
?>
    <div class="toolbar">
        <a class="btn ghost" href="<?php echo e($backUrl ?? route('admin.orders.show', $order)); ?>">Back to Order</a>
        <button class="btn" onclick="window.print()">Print / Save PDF</button>
    </div>
    <main class="sheet">
        <section class="top">
            <div class="brand">
                <img src="<?php echo e($docLogoUrl); ?>" alt="<?php echo e($docSiteName); ?>">
                <div>
                    <h1><?php echo e($docSiteName); ?></h1>
                    <p><?php echo e($docTagline); ?></p>
                    <p><strong>Support:</strong> <?php echo e($docSupportPhone); ?></p>
                </div>
            </div>
            <div class="doc-title">
                <h2><?php echo e($documentType ?? 'Invoice'); ?></h2>
                <p><strong><?php echo e($order->order_number); ?></strong></p>
                <p><?php echo e(optional($order->created_at)->format('d M Y, h:i A')); ?></p>
            </div>
        </section>
        ...
        <section class="meta-grid">
            <div class="box">
                ...
                <p>Phone: <?php echo e($order->customer_phone); ?></p>
                <p>Email: <?php echo e($order->customer_email ?: 'N/A'); ?></p>
                <p>Address: <?php echo e($order->address_line ?: 'N/A'); ?></p>
                <p>Thana / Area: <?php echo e($order->area ?: 'N/A'); ?></p>
                <p>District: <?php echo e($order->city ?: 'Dhaka'); ?></p>
            </div>
            <div class="box">
                <h3>Order & Payment</h3>
                <p>Status: <strong><?php echo e(ucfirst($order->order_status)); ?></strong></p>
                <p>Payment: <strong><?php echo e($order->paymentMethodLabel()); ?></strong></p>
                <p>Payment Status: <strong><?php echo e(ucfirst($order->payment_status)); ?></strong></p>
                <?php if($order->payment_method !== 'cod'): ?>
                    <p>Payment Account: <?php echo e($order->payment_account ?: 'N/A'); ?></p>
                    <p>Sender Number: <?php echo e($order->payment_sender_number ?: 'N/A'); ?></p>
                    <p>Transaction ID: <?php echo e($order->payment_transaction_id ?: 'N/A'); ?></p>
                <?php endif; ?>
            </div>
        </section>
                ...
                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            ...
                            <?php if($item->variation_name): ?><br><span class="muted"><?php echo e($item->variation_name); ?></span><?php endif; ?>
                        </td>
                        ...
                        <td class="num">৳<?php echo e(number_format($item->line_total, 0)); ?></td>
                    </tr>
        ...
        <section class="summary">
            <div class="summary-row"><span>Subtotal</span><strong>৳<?php echo e(number_format($order->subtotal, 0)); ?></strong></div>
            <?php if($order->coupon_code): ?><div class="summary-row"><span>Coupon (<?php echo e($order->coupon_code); ?>)</span><strong>-৳<?php echo e(number_format($order->discount_total, 0)); ?></strong></div><?php else: ?><div class="summary-row"><span>Discount</span><strong>৳<?php echo e(number_format($order->discount_total, 0)); ?></strong></div><?php endif; ?>
            <div class="summary-row"><span>Shipping</span><strong><?php echo e((float)$order->shipping_total === 0.0 ? 'Free' : '৳' . number_format($order->shipping_total, 0)); ?></strong></div>
            <div class="summary-row total"><span>Total</span><span>৳<?php echo e(number_format($order->grand_total, 0)); ?></span></div>
        </section>

        <?php if($order->customer_note || $order->admin_note): ?>
            <div class="note">
                <?php if($order->customer_note): ?><p><strong>Customer Note:</strong> <?php echo e($order->customer_note); ?></p><?php endif; ?>
                <?php if($order->admin_note): ?><p><strong>Admin Note:</strong> <?php echo e($order->admin_note); ?></p><?php endif; ?>
            </div>
        <?php endif; ?>

        <section class="footer">
            <span>Thank you for shopping with <?php echo e($docSiteName); ?>.</span>
            <span>Generated on <?php echo e(now()->format('d M Y, h:i A')); ?></span>
        </section>
    </main>
</body>
</html>
<?php /**PATH /home/niyamulp/prosanatelier_app/resources/views/admin/orders/invoice.blade.php ENDPATH**/ ?>